...
public class DetailReviewSliderAdapter extends PagerAdapter {
    ...
    private int[] images = {R.drawable.iu1, R.drawable.iu2, R.drawable.iu4};
    private LayoutInflater inflater;
    private Context context;

    // 해당 context가 자신의 context 객체와 똑같이 되도록 생성자를 만듬
    public DetailReviewSliderAdapter(Context context){
...
//        return view == ((LinearLayout)object); 으로 했을때 오류 나서 View 로 바꿈..
    ...
    public Object instantiateItem( ViewGroup container, int position) {
        ...
        View v = inflater.inflate(R.layout.slider_detail_review, container, false);
        ImageView imageView = (ImageView)v.findViewById(R.id.cosmetic_img);
